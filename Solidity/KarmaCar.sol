//Contstructor args used: ["0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030","0x32303139313233313233303030302b31303030"],"HongKou Technology","Tenggu Road","Shanghai","Shanghai","KARMA","Karma Car"
...
contract KarmaCar
{
    ...
    event Trade(address indexed seller, uint256[] TokenIndices, uint8 v, bytes32 r, bytes32 s);
    event PassTo(uint256[] TokenIndices, uint8 v, bytes32 r, bytes32 s, address indexed recipient);
    ...
    function transfer(address _to, uint256[] TokenIndices)
    {
        for(uint i = 0; i < TokenIndices.length; i++)
        {
